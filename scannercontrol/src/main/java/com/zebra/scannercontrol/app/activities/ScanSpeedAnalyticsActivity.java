                                        ...
                                        if(text!=null) {
                                            ...
                                            if (selectedSSASymbology.getAttrIDMaxDecodeTime() == attrId) {
                                                ...
                                                runOnUiThread(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        slowestDecodeDataValue = new String(hexStringToString(attrVal));
                                                    }
                                                });
